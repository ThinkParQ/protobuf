...
pub struct VerifyCertResult {
    #[prost(enumeration = "VerifyResult", optional, tag = "1")]
...
pub struct CertData {
    ...
    #[prost(enumeration = "CertType", optional, tag = "1")]
    ...
    pub serial: ::core::option::Option<i64>,
    ...
    pub organizational_unit: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "5")]
    pub country: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "6")]
    pub locality: ::core::option::Option<::prost::alloc::string::String>,
    /// commonName contains the string serial number
    #[prost(string, optional, tag = "7")]
    pub common_name: ::core::option::Option<::prost::alloc::string::String>,
