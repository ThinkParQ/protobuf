...
type VerifyCertResult struct {
	...
	Result *VerifyResult `protobuf:"varint,1,opt,name=result,proto3,enum=license.VerifyResult,oneof" json:"result,omitempty"`
...
type GetCertDataResult struct {
	...
	// verification failed.
	Data *CertData `protobuf:"bytes,2,opt,name=data,proto3,oneof" json:"data,omitempty"`
	// Error or status message. Empty if verification succeeded. Contains the error message if
	// result == VERIFY_ERROR and the reason for verification failure if result == VERIFY_INVALID.
	Message *string `protobuf:"bytes,3,opt,name=message,proto3,oneof" json:"message,omitempty"`
}
...
type CertData struct {
	...
	Type *CertType `protobuf:"varint,1,opt,name=type,proto3,enum=license.CertType,oneof" json:"type,omitempty"`
	...
	Serial *int64 `protobuf:"varint,2,opt,name=serial,proto3,oneof" json:"serial,omitempty"`
	...
	OrganizationalUnit *string `protobuf:"bytes,4,opt,name=organizationalUnit,proto3,oneof" json:"organizationalUnit,omitempty"`
	Country            *string `protobuf:"bytes,5,opt,name=country,proto3,oneof" json:"country,omitempty"`
	Locality           *string `protobuf:"bytes,6,opt,name=locality,proto3,oneof" json:"locality,omitempty"`
	// commonName contains the string serial number
	CommonName *string `protobuf:"bytes,7,opt,name=commonName,proto3,oneof" json:"commonName,omitempty"`
	// Fields 8 and 9 encode the certificate's validity period
	ValidFrom  *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=validFrom,proto3,oneof" json:"validFrom,omitempty"`
	ValidUntil *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=validUntil,proto3,oneof" json:"validUntil,omitempty"`
	...
	// certificates.
	IsCa *bool `protobuf:"varint,11,opt,name=is_ca,json=isCa,proto3,oneof" json:"is_ca,omitempty"`
	// The certificate's parent or "Issuer" certificate
	ParentData *CertData `protobuf:"bytes,12,opt,name=parent_data,json=parentData,proto3,oneof" json:"parent_data,omitempty"`
}
...
var file_license_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
...
func file_license_proto_init() {
	...
	file_license_proto_msgTypes[1].OneofWrappers = []any{}
	file_license_proto_msgTypes[2].OneofWrappers = []any{}
