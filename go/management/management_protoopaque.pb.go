...
type GetNodesResponse struct {
	...
	xxx_hidden_MetaRootBuddyGroup *beegfs.EntityIdSet       `protobuf:"bytes,4,opt,name=meta_root_buddy_group,json=metaRootBuddyGroup,proto3,oneof" json:"meta_root_buddy_group,omitempty"`
...
func (x *GetNodesResponse) GetMetaRootBuddyGroup() *beegfs.EntityIdSet {
	if x != nil {
		return x.xxx_hidden_MetaRootBuddyGroup
	}
	return nil
}
...
func (x *GetNodesResponse) SetMetaRootBuddyGroup(v *beegfs.EntityIdSet) {
	x.xxx_hidden_MetaRootBuddyGroup = v
}
...
func (x *GetNodesResponse) HasMetaRootBuddyGroup() bool {
	...
	return x.xxx_hidden_MetaRootBuddyGroup != nil
}
...
func (x *GetNodesResponse) ClearMetaRootBuddyGroup() {
	x.xxx_hidden_MetaRootBuddyGroup = nil
}
...
func (b0 GetNodesResponse_builder) Build() *GetNodesResponse {
	...
	x.xxx_hidden_MetaRootBuddyGroup = b.MetaRootBuddyGroup
	return m0
}
...
func (x *BuddyGroupOptions) GetQuotaAccounting() BuddyGroupOptions_BuddyGroupQuotaAccounting {
	if x != nil {
		if protoimpl.X.Present(&(x.XXX_presence[0]), 0) {
			return x.xxx_hidden_QuotaAccounting
		}
	}
...
func (x *BuddyGroupOptions) SetQuotaAccounting(v BuddyGroupOptions_BuddyGroupQuotaAccounting) {
	x.xxx_hidden_QuotaAccounting = v
...
func (x *BuddyGroupOptions) ClearQuotaAccounting() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_QuotaAccounting = BuddyGroupOptions_BUDDY_GROUP_QUOTA_ACCOUNTING_UNSPECIFIED
}
...
func (b0 BuddyGroupOptions_builder) Build() *BuddyGroupOptions {
	...
	b, x := &b0, m0
	_, _ = b, x
	if b.QuotaAccounting != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 1)
		x.xxx_hidden_QuotaAccounting = *b.QuotaAccounting
	}
	return m0
}
...
type CreateBuddyGroupRequest struct {
	...
	xxx_hidden_Options         *BuddyGroupOptions     `protobuf:"bytes,6,opt,name=options,proto3,oneof" json:"options,omitempty"`
	XXX_raceDetectHookData     protoimpl.RaceDetectHookData
	XXX_presence               [1]uint32
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
...
type ModifyBuddyGroupRequest struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Group   *beegfs.EntityIdSet    `protobuf:"bytes,1,opt,name=group,proto3,oneof" json:"group,omitempty"`
	xxx_hidden_Options *BuddyGroupOptions     `protobuf:"bytes,2,opt,name=options,proto3,oneof" json:"options,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type GetBuddyGroupsResponse_BuddyGroup struct {
	...
	xxx_hidden_Options                   *BuddyGroupOptions      `protobuf:"bytes,8,opt,name=options,proto3,oneof" json:"options,omitempty"`
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
}
