...
type GetNodesResponse struct {
	...
	xxx_hidden_MetaRootMirror *beegfs.EntityIdSet       `protobuf:"bytes,3,opt,name=meta_root_mirror,json=metaRootMirror,proto3,oneof" json:"meta_root_mirror,omitempty"`
	xxx_hidden_FsUuid         *string                   `protobuf:"bytes,4,opt,name=fs_uuid,json=fsUuid,proto3,oneof" json:"fs_uuid,omitempty"`
...
func (x *GetNodesResponse) GetMetaRootMirror() *beegfs.EntityIdSet {
	if x != nil {
		return x.xxx_hidden_MetaRootMirror
	}
	return nil
}
...
func (x *GetNodesResponse) HasMetaRootMirror() bool {
	...
	return x.xxx_hidden_MetaRootMirror != nil
}
...
func (x *GetNodesResponse) ClearMetaRootMirror() {
	x.xxx_hidden_MetaRootMirror = nil
}
...
func (b0 GetNodesResponse_builder) Build() *GetNodesResponse {
	...
	x.xxx_hidden_MetaRootMirror = b.MetaRootMirror
	if b.FsUuid != nil {
