...
type ManagementClient interface {
	...
	GetQuotaLimits(ctx context.Context, in *GetQuotaLimitsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetQuotaLimitsResponse], error)
	GetQuotaUsage(ctx context.Context, in *GetQuotaUsageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetQuotaUsageResponse], error)
	// Licensing
...
func (c *managementClient) GetQuotaLimits(ctx context.Context, in *GetQuotaLimitsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetQuotaLimitsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Management_ServiceDesc.Streams[0], Management_GetQuotaLimits_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetQuotaLimitsRequest, GetQuotaLimitsResponse]{ClientStream: stream}
...
type Management_GetQuotaLimitsClient = grpc.ServerStreamingClient[GetQuotaLimitsResponse]

func (c *managementClient) GetQuotaUsage(ctx context.Context, in *GetQuotaUsageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetQuotaUsageResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Management_ServiceDesc.Streams[1], Management_GetQuotaUsage_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetQuotaUsageRequest, GetQuotaUsageResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Management_GetQuotaUsageClient = grpc.ServerStreamingClient[GetQuotaUsageResponse]
...
type ManagementServer interface {
	...
	GetQuotaLimits(*GetQuotaLimitsRequest, grpc.ServerStreamingServer[GetQuotaLimitsResponse]) error
	GetQuotaUsage(*GetQuotaUsageRequest, grpc.ServerStreamingServer[GetQuotaUsageResponse]) error
	// Licensing
...
func (UnimplementedManagementServer) GetQuotaLimits(*GetQuotaLimitsRequest, grpc.ServerStreamingServer[GetQuotaLimitsResponse]) error {
	return status.Errorf(codes.Unimplemented, "method GetQuotaLimits not implemented")
}
func (UnimplementedManagementServer) GetQuotaUsage(*GetQuotaUsageRequest, grpc.ServerStreamingServer[GetQuotaUsageResponse]) error {
...
func _Management_GetQuotaLimits_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagementServer).GetQuotaLimits(m, &grpc.GenericServerStream[GetQuotaLimitsRequest, GetQuotaLimitsResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Management_GetQuotaLimitsServer = grpc.ServerStreamingServer[GetQuotaLimitsResponse]
...
func _Management_GetQuotaUsage_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ManagementServer).GetQuotaUsage(m, &grpc.GenericServerStream[GetQuotaUsageRequest, GetQuotaUsageResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Management_GetQuotaUsageServer = grpc.ServerStreamingServer[GetQuotaUsageResponse]
