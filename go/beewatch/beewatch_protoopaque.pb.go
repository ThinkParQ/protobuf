...
type EventFilter struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_V1Types []V1Event_Type         `protobuf:"varint,1,rep,packed,name=v1_types,json=v1Types,proto3,enum=beewatch.V1Event_Type" json:"v1_types,omitempty"`
	xxx_hidden_V2Types []V2Event_Type         `protobuf:"varint,2,rep,packed,name=v2_types,json=v2Types,proto3,enum=beewatch.V2Event_Type" json:"v2_types,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (b0 EventFilter_builder) Build() *EventFilter {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_V1Types = b.V1Types
	x.xxx_hidden_V2Types = b.V2Types
	return m0
}
...
type Response struct {
	...
	xxx_hidden_Filter       *EventFilter           `protobuf:"bytes,3,opt,name=filter,proto3,oneof" json:"filter,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
