...
type JobLockedInfo struct {
	...
	UserXattrs       map[string]string `protobuf:"bytes,11,rep,name=user_xattrs,json=userXattrs,proto3" json:"user_xattrs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	RemoteUserXattrs map[string]string `protobuf:"bytes,12,rep,name=remote_user_xattrs,json=remoteUserXattrs,proto3" json:"remote_user_xattrs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (b0 JobLockedInfo_builder) Build() *JobLockedInfo {
	...
	x.UserXattrs = b.UserXattrs
	x.RemoteUserXattrs = b.RemoteUserXattrs
	return m0
}
...
type JobRequestCfg struct {
	...
	EnableXattr         *bool                  `protobuf:"varint,15,opt,name=enable_xattr,json=enableXattr,proto3,oneof" json:"enable_xattr,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *JobRequestCfg) GetEnableXattr() bool {
	if x != nil && x.EnableXattr != nil {
		return *x.EnableXattr
	}
	return false
}
