...
func (x *WorkRequest) GetDirSync() *DirSyncJob {
	if x != nil {
		if x, ok := x.Type.(*WorkRequest_DirSync); ok {
			return x.DirSync
		}
	}
	return nil
...
func (x *WorkRequest) HasDirSync() bool {
	...
	_, ok := x.Type.(*WorkRequest_DirSync)
	return ok
}
...
func (x *WorkRequest) ClearDirSync() {
	if _, ok := x.Type.(*WorkRequest_DirSync); ok {
		x.Type = nil
	}
}
...
func (b0 WorkRequest_builder) Build() *WorkRequest {
	...
	if b.DirSync != nil {
		x.Type = &WorkRequest_DirSync{b.DirSync}
	}
	return m0
}
...
type SyncJob struct {
	state     protoimpl.MessageState `protogen:"hybrid.v1"`
	Operation JobOperation           `protobuf:"varint,1,opt,name=operation,proto3,enum=flex.JobOperation" json:"operation,omitempty"`
...
type DirSyncJob struct {
	...
	StubOnly      bool `protobuf:"varint,6,opt,name=stub_only,json=stubOnly,proto3" json:"stub_only,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
