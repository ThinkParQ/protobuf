...
type RemoteStorageTarget_Azure struct {
	...
	AzuriteUrl    string `protobuf:"bytes,6,opt,name=azurite_url,json=azuriteUrl,proto3" json:"azurite_url,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 RemoteStorageTarget_Azure_builder) Build() *RemoteStorageTarget_Azure {
	...
	x.AccountKey = b.AccountKey
	x.Container = b.Container
	x.AzuriteUrl = b.AzuriteUrl
	return m0
}
