...
type RemoteStorageTarget_S3_StorageClass_Archival struct {
	...
	PlacementHints string `protobuf:"bytes,6,opt,name=placement_hints,json=placementHints,proto3" json:"placement_hints,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (b0 RemoteStorageTarget_S3_StorageClass_Archival_builder) Build() *RemoteStorageTarget_S3_StorageClass_Archival {
	...
	x.PlacementHints = b.PlacementHints
	return m0
}
