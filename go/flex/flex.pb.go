...
type RemoteStorageTarget_S3 struct {
	...
	ArchiveRestoreRetentionDays int32 `protobuf:"varint,7,opt,name=archive_restore_retention_days,json=archiveRestoreRetentionDays,proto3" json:"archive_restore_retention_days,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *RemoteStorageTarget_S3) GetArchiveRestoreRetentionDays() int32 {
	if x != nil {
		return x.ArchiveRestoreRetentionDays
	}
	return 0
}
...
func (x *RemoteStorageTarget_S3) SetArchiveRestoreRetentionDays(v int32) {
	x.ArchiveRestoreRetentionDays = v
}
...
func (b0 RemoteStorageTarget_S3_builder) Build() *RemoteStorageTarget_S3 {
	...
	x.ArchiveRestoreRetentionDays = b.ArchiveRestoreRetentionDays
	return m0
}
