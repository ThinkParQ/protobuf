...
type HeartbeatResponse struct {
	...
	State         HeartbeatResponse_State `protobuf:"varint,3,opt,name=state,proto3,enum=flex.HeartbeatResponse_State" json:"state,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SubmitWorkResponse struct {
	...
	Status        SubmitWorkResponse_ResponseStatus `protobuf:"varint,2,opt,name=status,proto3,enum=flex.SubmitWorkResponse_ResponseStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type JobLockedInfo struct {
	...
	ReadWriteLocked bool `protobuf:"varint,1,opt,name=read_write_locked,json=readWriteLocked,proto3" json:"read_write_locked,omitempty"`
...
func (b0 JobLockedInfo_builder) Build() *JobLockedInfo {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.ReadWriteLocked = b.ReadWriteLocked
	x.Exists = b.Exists
	x.Size = b.Size
	x.Mode = b.Mode
	x.Mtime = b.Mtime
...
type JobRequestCfg struct {
	...
	Update              *bool                  `protobuf:"varint,10,opt,name=update,proto3,oneof" json:"update,omitempty"`
	...
	Tagging             *string                `protobuf:"bytes,14,opt,name=tagging,proto3,oneof" json:"tagging,omitempty"`
	Priority            *int32                 `protobuf:"varint,11,opt,name=priority,proto3,oneof" json:"priority,omitempty"`
	StorageClass        *string                `protobuf:"bytes,12,opt,name=storage_class,json=storageClass,proto3,oneof" json:"storage_class,omitempty"`
	AllowRestore        *bool                  `protobuf:"varint,15,opt,name=allow_restore,json=allowRestore,proto3,oneof" json:"allow_restore,omitempty"`
	FilterExpr          *string                `protobuf:"bytes,16,opt,name=filter_expr,json=filterExpr,proto3,oneof" json:"filter_expr,omitempty"`
	// Controls the data state of the stub file when stub_local is true.
	RestorePolicy *RestorePolicy `protobuf:"varint,17,opt,name=restore_policy,json=restorePolicy,proto3,enum=flex.RestorePolicy,oneof" json:"restore_policy,omitempty"`
	...
	CooldownSecs  *uint32 `protobuf:"varint,18,opt,name=cooldown_secs,json=cooldownSecs,proto3,oneof" json:"cooldown_secs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JobRequestCfg) GetAllowRestore() bool {
	if x != nil && x.AllowRestore != nil {
		return *x.AllowRestore
	}
	return false
}
...
func (b0 JobRequestCfg_builder) Build() *JobRequestCfg {
	...
	x.AllowRestore = b.AllowRestore
	x.FilterExpr = b.FilterExpr
	x.RestorePolicy = b.RestorePolicy
	x.CooldownSecs = b.CooldownSecs
	return m0
}
...
type WorkRequest struct {
	...
	// Controls the data state of the stub file when stub_local is true.
	RestorePolicy *RestorePolicy `protobuf:"varint,13,opt,name=restore_policy,json=restorePolicy,proto3,enum=flex.RestorePolicy,oneof" json:"restore_policy,omitempty"`
	// Time in seconds to wait after a file is closed before replication begins.
	CooldownSecs *uint32 `protobuf:"varint,14,opt,name=cooldown_secs,json=cooldownSecs,proto3,oneof" json:"cooldown_secs,omitempty"`
	...
	BulkInfo      *BulkJobRequestInfo `protobuf:"bytes,16,opt,name=bulk_info,json=bulkInfo,proto3,oneof" json:"bulk_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BulkJobRequestInfo struct {
	...
	StateMountPath string `protobuf:"bytes,1,opt,name=state_mount_path,json=stateMountPath,proto3" json:"state_mount_path,omitempty"`
	...
	JobIndex      int64 `protobuf:"varint,3,opt,name=job_index,json=jobIndex,proto3" json:"job_index,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 BulkJobRequestInfo_builder) Build() *BulkJobRequestInfo {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.StateMountPath = b.StateMountPath
	x.Operation = b.Operation
	x.JobIndex = b.JobIndex
	return m0
}
...
type BuilderJob struct {
	...
	JobsAlreadyExist int32 `protobuf:"varint,8,opt,name=jobs_already_exist,json=jobsAlreadyExist,proto3" json:"jobs_already_exist,omitempty"`
	// Number of jobs for which there's an existing equivalent failed job.
	JobsNotAllowed int32 `protobuf:"varint,9,opt,name=jobs_not_allowed,json=jobsNotAllowed,proto3" json:"jobs_not_allowed,omitempty"`
	// Number of jobs that were already complete.
	JobsAlreadyComplete int32 `protobuf:"varint,10,opt,name=jobs_already_complete,json=jobsAlreadyComplete,proto3" json:"jobs_already_complete,omitempty"`
	// Number of jobs that were already offloaded.
	JobsAlreadyOffloaded int32 `protobuf:"varint,11,opt,name=jobs_already_offloaded,json=jobsAlreadyOffloaded,proto3" json:"jobs_already_offloaded,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (b0 BuilderJob_builder) Build() *BuilderJob {
	...
	x.Errors = b.Errors
	x.JobsAlreadyExist = b.JobsAlreadyExist
	x.JobsNotAllowed = b.JobsNotAllowed
	x.JobsAlreadyComplete = b.JobsAlreadyComplete
	x.JobsAlreadyOffloaded = b.JobsAlreadyOffloaded
	return m0
}
...
type SyncJob struct {
	...
	LockedInfo    *JobLockedInfo    `protobuf:"bytes,6,opt,name=locked_info,json=lockedInfo,proto3" json:"locked_info,omitempty"`
	Update        *bool             `protobuf:"varint,7,opt,name=update,proto3,oneof" json:"update,omitempty"`
	Metadata      map[string]string `protobuf:"bytes,9,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Tagging       *string           `protobuf:"bytes,10,opt,name=tagging,proto3,oneof" json:"tagging,omitempty"`
	StorageClass  *string           `protobuf:"bytes,12,opt,name=storage_class,json=storageClass,proto3,oneof" json:"storage_class,omitempty"`
	AllowRestore  *bool             `protobuf:"varint,13,opt,name=allow_restore,json=allowRestore,proto3,oneof" json:"allow_restore,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BeeRemoteNode struct {
	...
	MgmtdAddress                string                 `protobuf:"bytes,3,opt,name=mgmtd_address,json=mgmtdAddress,proto3" json:"mgmtd_address,omitempty"`
	MgmtdTlsCert                []byte                 `protobuf:"bytes,4,opt,name=mgmtd_tls_cert,json=mgmtdTlsCert,proto3" json:"mgmtd_tls_cert,omitempty"`
	...
	MgmtdUseProxy               bool                   `protobuf:"varint,9,opt,name=mgmtd_use_proxy,json=mgmtdUseProxy,proto3" json:"mgmtd_use_proxy,omitempty"`
	AuthSecret                  []byte                 `protobuf:"bytes,7,opt,name=auth_secret,json=authSecret,proto3" json:"auth_secret,omitempty"`
...
func (x *RemoteStorageTarget) GetXtreemstore() *RemoteStorageTarget_XtreemStore {
	if x != nil {
		if x, ok := x.Type.(*RemoteStorageTarget_Xtreemstore); ok {
...
func (x *RemoteStorageTarget) SetXtreemstore(v *RemoteStorageTarget_XtreemStore) {
	...
	x.Type = &RemoteStorageTarget_Xtreemstore{v}
}
...
func (x *RemoteStorageTarget) HasXtreemstore() bool {
	...
	_, ok := x.Type.(*RemoteStorageTarget_Xtreemstore)
	return ok
}
...
func (x *RemoteStorageTarget) ClearXtreemstore() {
	if _, ok := x.Type.(*RemoteStorageTarget_Xtreemstore); ok {
		x.Type = nil
	}
}
...
func (b0 RemoteStorageTarget_builder) Build() *RemoteStorageTarget {
	...
	if b.Xtreemstore != nil {
		x.Type = &RemoteStorageTarget_Xtreemstore{b.Xtreemstore}
	}
	return m0
}
...
type GetCapabilitiesResponse struct {
	...
	Features map[string]*Feature `protobuf:"bytes,2,rep,name=features,proto3" json:"features,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Feature struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	SubFeature    map[string]*Feature    `protobuf:"bytes,1,rep,name=sub_feature,json=subFeature,proto3" json:"sub_feature,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RemoteStorageTarget_S3 struct {
	...
	// supported.
	StorageClass  []*RemoteStorageTarget_S3_StorageClass `protobuf:"bytes,8,rep,name=storage_class,json=storageClass,proto3" json:"storage_class,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RemoteStorageTarget_S3_StorageClass struct {
	...
	Archival      *RemoteStorageTarget_S3_StorageClass_Archival `protobuf:"bytes,2,opt,name=archival,proto3,oneof" json:"archival,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 RemoteStorageTarget_S3_StorageClass_builder) Build() *RemoteStorageTarget_S3_StorageClass {
	...
	_, _ = b, x
	x.Name = b.Name
	x.Archival = b.Archival
	return m0
}

type RemoteStorageTarget_S3_StorageClass_Archival struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	RetrievalTier string                 `protobuf:"bytes,1,opt,name=retrieval_tier,json=retrievalTier,proto3" json:"retrieval_tier,omitempty"`
	...
	CheckTime string `protobuf:"bytes,3,opt,name=check_time,json=checkTime,proto3" json:"check_time,omitempty"`
	// Subsequent retry polling duration. Should be a positive number with a valid time
	// unit (ms, s, m, h). For example, "30m"
	RecheckTime string `protobuf:"bytes,4,opt,name=recheck_time,json=recheckTime,proto3" json:"recheck_time,omitempty"`
	// Automatically restore from this storage class when needed.
	AutoRestore   bool `protobuf:"varint,5,opt,name=auto_restore,json=autoRestore,proto3" json:"auto_restore,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 RemoteStorageTarget_S3_StorageClass_Archival_builder) Build() *RemoteStorageTarget_S3_StorageClass_Archival {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.RetrievalTier = b.RetrievalTier
	x.RetentionDays = b.RetentionDays
	x.CheckTime = b.CheckTime
	x.RecheckTime = b.RecheckTime
	x.AutoRestore = b.AutoRestore
	return m0
}
