...
type JobRequestCfg struct {
	...
	EnableXattr         *bool                  `protobuf:"varint,12,opt,name=enable_xattr,json=enableXattr,proto3,oneof" json:"enable_xattr,omitempty"`
	MetaTags            map[string]string      `protobuf:"bytes,13,rep,name=meta_tags,json=metaTags,proto3" json:"meta_tags,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type SyncJob struct {
	...
	EnableXattr   *bool             `protobuf:"varint,8,opt,name=enable_xattr,json=enableXattr,proto3,oneof" json:"enable_xattr,omitempty"`
	MetaTags      map[string]string `protobuf:"bytes,9,rep,name=meta_tags,json=metaTags,proto3" json:"meta_tags,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
