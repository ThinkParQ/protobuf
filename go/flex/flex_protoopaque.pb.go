...
type DirSyncJob_Operation int32

const (
	DirSyncJob_UNSPECIFIED DirSyncJob_Operation = 0
	DirSyncJob_UPLOAD      DirSyncJob_Operation = 1
	DirSyncJob_DOWNLOAD    DirSyncJob_Operation = 2
)

// Enum value maps for DirSyncJob_Operation.
var (
	DirSyncJob_Operation_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "UPLOAD",
		2: "DOWNLOAD",
	}
	DirSyncJob_Operation_value = map[string]int32{
		"UNSPECIFIED": 0,
		"UPLOAD":      1,
		"DOWNLOAD":    2,
	}
...
func (x DirSyncJob_Operation) Enum() *DirSyncJob_Operation {
	p := new(DirSyncJob_Operation)
	*p = x
	return p
}

func (x DirSyncJob_Operation) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DirSyncJob_Operation) Descriptor() protoreflect.EnumDescriptor {
	return file_flex_proto_enumTypes[3].Descriptor()
}

func (DirSyncJob_Operation) Type() protoreflect.EnumType {
	return &file_flex_proto_enumTypes[3]
}

func (x DirSyncJob_Operation) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
type DirSyncJob struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Operation  DirSyncJob_Operation   `protobuf:"varint,1,opt,name=operation,proto3,enum=flex.DirSyncJob_Operation" json:"operation,omitempty"`
	xxx_hidden_Overwrite  bool                   `protobuf:"varint,2,opt,name=overwrite,proto3" json:"overwrite,omitempty"`
	xxx_hidden_RemotePath string                 `protobuf:"bytes,3,opt,name=remote_path,json=remotePath,proto3" json:"remote_path,omitempty"`
...
func (x *DirSyncJob) GetOperation() DirSyncJob_Operation {
	if x != nil {
		return x.xxx_hidden_Operation
	}
	return DirSyncJob_UNSPECIFIED
}
...
func (x *DirSyncJob) SetOperation(v DirSyncJob_Operation) {
	x.xxx_hidden_Operation = v
}
...
type DirSyncJob_builder struct {
	...
	Operation DirSyncJob_Operation
...
var file_flex_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0xd4, 0x01, 0x0a, 0x07, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x12, 0x35, 0x0a,
	...
	0x61, 0x74, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x74, 0x75, 0x62, 0x5f, 0x6f, 0x6e, 0x6c, 0x79,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x73, 0x74, 0x75, 0x62, 0x4f, 0x6e, 0x6c, 0x79,
	...
	0x57, 0x4e, 0x4c, 0x4f, 0x41, 0x44, 0x10, 0x02, 0x22, 0x8a, 0x02, 0x0a, 0x0a, 0x44, 0x69, 0x72,
	0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x12, 0x38, 0x0a, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x66, 0x6c, 0x65,
	0x78, 0x2e, 0x44, 0x69, 0x72, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x2e, 0x4f, 0x70, 0x65,
	...
	0x12, 0x1b, 0x0a, 0x09, 0x73, 0x74, 0x75, 0x62, 0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x08, 0x73, 0x74, 0x75, 0x62, 0x4f, 0x6e, 0x6c, 0x79, 0x22, 0x36, 0x0a,
	...
	0x4f, 0x41, 0x44, 0x10, 0x02, 0x22, 0xc8, 0x04, 0x0a, 0x04, 0x57, 0x6f, 0x72, 0x6b, 0x12, 0x12,
	...
	0x61, 0x72, 0x74, 0x52, 0x05, 0x70, 0x61, 0x72, 0x74, 0x73, 0x1a, 0x4a, 0x0a, 0x06, 0x53, 0x74,
...
var file_flex_proto_goTypes = []any{
	...
	(DirSyncJob_Operation)(0),            // 3: flex.DirSyncJob.Operation
	...
	(*WorkRequest)(nil),                  // 15: flex.WorkRequest
	(*MockJob)(nil),                      // 16: flex.MockJob
	(*SyncJob)(nil),                      // 17: flex.SyncJob
	(*DirSyncJob)(nil),                   // 18: flex.DirSyncJob
	(*Work)(nil),                         // 19: flex.Work
	(*UpdateConfigRequest)(nil),          // 20: flex.UpdateConfigRequest
	(*UpdateConfigResponse)(nil),         // 21: flex.UpdateConfigResponse
	(*BeeRemoteNode)(nil),                // 22: flex.BeeRemoteNode
	(*RemoteStorageTarget)(nil),          // 23: flex.RemoteStorageTarget
	(*WorkRequest_Segment)(nil),          // 24: flex.WorkRequest.Segment
	(*Work_Status)(nil),                  // 25: flex.Work.Status
	(*Work_Part)(nil),                    // 26: flex.Work.Part
	(*RemoteStorageTarget_Policies)(nil), // 27: flex.RemoteStorageTarget.Policies
	(*RemoteStorageTarget_S3)(nil),       // 28: flex.RemoteStorageTarget.S3
	(*RemoteStorageTarget_Azure)(nil),    // 29: flex.RemoteStorageTarget.Azure
	(*RemoteStorageTarget_POSIX)(nil),    // 30: flex.RemoteStorageTarget.POSIX
	(*timestamppb.Timestamp)(nil),        // 31: google.protobuf.Timestamp
}
var file_flex_proto_depIdxs = []int32{
	8,  // 0: flex.HeartbeatResponse.node_stats:type_name -> flex.NodeStats
	31, // 1: flex.NodeStats.timestamp:type_name -> google.protobuf.Timestamp
	15, // 2: flex.SubmitWorkRequest.request:type_name -> flex.WorkRequest
	19, // 3: flex.SubmitWorkResponse.work:type_name -> flex.Work
	0,  // 4: flex.UpdateWorkRequest.new_state:type_name -> flex.UpdateWorkRequest.NewState
	19, // 5: flex.UpdateWorkResponse.work:type_name -> flex.Work
	1,  // 6: flex.BulkUpdateWorkRequest.new_state:type_name -> flex.BulkUpdateWorkRequest.NewState
	24, // 7: flex.WorkRequest.segment:type_name -> flex.WorkRequest.Segment
	16, // 8: flex.WorkRequest.mock:type_name -> flex.MockJob
	17, // 9: flex.WorkRequest.sync:type_name -> flex.SyncJob
	18, // 10: flex.WorkRequest.dir_sync:type_name -> flex.DirSyncJob
	2,  // 11: flex.SyncJob.operation:type_name -> flex.SyncJob.Operation
	3,  // 12: flex.DirSyncJob.operation:type_name -> flex.DirSyncJob.Operation
	25, // 13: flex.Work.status:type_name -> flex.Work.Status
	26, // 14: flex.Work.parts:type_name -> flex.Work.Part
	22, // 15: flex.UpdateConfigRequest.bee_remote:type_name -> flex.BeeRemoteNode
	23, // 16: flex.UpdateConfigRequest.rsts:type_name -> flex.RemoteStorageTarget
	5,  // 17: flex.UpdateConfigResponse.result:type_name -> flex.UpdateConfigResponse.Result
	27, // 18: flex.RemoteStorageTarget.policies:type_name -> flex.RemoteStorageTarget.Policies
	28, // 19: flex.RemoteStorageTarget.s3:type_name -> flex.RemoteStorageTarget.S3
	30, // 20: flex.RemoteStorageTarget.posix:type_name -> flex.RemoteStorageTarget.POSIX
	29, // 21: flex.RemoteStorageTarget.azure:type_name -> flex.RemoteStorageTarget.Azure
	4,  // 22: flex.Work.Status.state:type_name -> flex.Work.State
	28, // 23: flex.RemoteStorageTarget.Azure.s3:type_name -> flex.RemoteStorageTarget.S3
	20, // 24: flex.WorkerNode.UpdateConfig:input_type -> flex.UpdateConfigRequest
	6,  // 25: flex.WorkerNode.Heartbeat:input_type -> flex.HeartbeatRequest
	9,  // 26: flex.WorkerNode.SubmitWork:input_type -> flex.SubmitWorkRequest
	11, // 27: flex.WorkerNode.UpdateWork:input_type -> flex.UpdateWorkRequest
	13, // 28: flex.WorkerNode.BulkUpdateWork:input_type -> flex.BulkUpdateWorkRequest
	21, // 29: flex.WorkerNode.UpdateConfig:output_type -> flex.UpdateConfigResponse
	7,  // 30: flex.WorkerNode.Heartbeat:output_type -> flex.HeartbeatResponse
	10, // 31: flex.WorkerNode.SubmitWork:output_type -> flex.SubmitWorkResponse
	12, // 32: flex.WorkerNode.UpdateWork:output_type -> flex.UpdateWorkResponse
	14, // 33: flex.WorkerNode.BulkUpdateWork:output_type -> flex.BulkUpdateWorkResponse
