...
const (
	JobOperation_OPERATION_UNSPECIFIED JobOperation = 0
	JobOperation_UPLOAD                JobOperation = 1
	JobOperation_DOWNLOAD              JobOperation = 2
)
...
func (x *WorkRequest) GetDirSync() *DirSyncJob {
	if x != nil {
		if x, ok := x.xxx_hidden_Type.(*workRequest_DirSync); ok {
			return x.DirSync
		}
	}
	return nil
...
func (x *WorkRequest) SetDirSync(v *DirSyncJob) {
	if v == nil {
		x.xxx_hidden_Type = nil
		return
	}
	x.xxx_hidden_Type = &workRequest_DirSync{v}
}
...
func (x *WorkRequest) HasDirSync() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Type.(*workRequest_DirSync)
	return ok
}
...
func (x *WorkRequest) ClearDirSync() {
	if _, ok := x.xxx_hidden_Type.(*workRequest_DirSync); ok {
		x.xxx_hidden_Type = nil
	}
}
...
const WorkRequest_DirSync_case case_WorkRequest_Type = 12
...
func (x *WorkRequest) WhichType() case_WorkRequest_Type {
	...
	case *workRequest_DirSync:
		return WorkRequest_DirSync_case
	default:
		return WorkRequest_Type_not_set_case
	}
}
...
func (b0 WorkRequest_builder) Build() *WorkRequest {
	...
	if b.DirSync != nil {
		x.xxx_hidden_Type = &workRequest_DirSync{b.DirSync}
	}
	return m0
}
...
type workRequest_DirSync struct {
	DirSync *DirSyncJob `protobuf:"bytes,12,opt,name=dir_sync,json=dirSync,proto3,oneof"`
}
...
func (*workRequest_DirSync) isWorkRequest_Type() {}
...
type SyncJob struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Operation  JobOperation           `protobuf:"varint,1,opt,name=operation,proto3,enum=flex.JobOperation" json:"operation,omitempty"`
...
func (x *SyncJob) GetOperation() JobOperation {
	if x != nil {
		return x.xxx_hidden_Operation
	}
	return JobOperation_OPERATION_UNSPECIFIED
}
...
func (x *SyncJob) SetOperation(v JobOperation) {
...
type DirSyncJob struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Operation  JobOperation           `protobuf:"varint,1,opt,name=operation,proto3,enum=flex.JobOperation" json:"operation,omitempty"`
	xxx_hidden_Overwrite  bool                   `protobuf:"varint,2,opt,name=overwrite,proto3" json:"overwrite,omitempty"`
	xxx_hidden_RemotePath string                 `protobuf:"bytes,3,opt,name=remote_path,json=remotePath,proto3" json:"remote_path,omitempty"`
	xxx_hidden_Flatten    bool                   `protobuf:"varint,4,opt,name=flatten,proto3" json:"flatten,omitempty"`
	xxx_hidden_Force      bool                   `protobuf:"varint,5,opt,name=force,proto3" json:"force,omitempty"`
	xxx_hidden_StubOnly   bool                   `protobuf:"varint,6,opt,name=stub_only,json=stubOnly,proto3" json:"stub_only,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}

func (x *DirSyncJob) Reset() {
	*x = DirSyncJob{}
...
func (x *DirSyncJob) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DirSyncJob) ProtoMessage() {}

func (x *DirSyncJob) ProtoReflect() protoreflect.Message {
	mi := &file_flex_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *DirSyncJob) GetOperation() JobOperation {
	if x != nil {
		return x.xxx_hidden_Operation
	}
	return JobOperation_OPERATION_UNSPECIFIED
...
func (x *DirSyncJob) GetOverwrite() bool {
	if x != nil {
		return x.xxx_hidden_Overwrite
	}
	return false
...
func (x *DirSyncJob) GetRemotePath() string {
	if x != nil {
		return x.xxx_hidden_RemotePath
	}
	return ""
...
func (x *DirSyncJob) GetFlatten() bool {
	if x != nil {
...
func (x *DirSyncJob) GetForce() bool {
	if x != nil {
...
func (x *DirSyncJob) GetStubOnly() bool {
	if x != nil {
		return x.xxx_hidden_StubOnly
	}
	return false
...
func (x *DirSyncJob) SetOperation(v JobOperation) {
	x.xxx_hidden_Operation = v
}

func (x *DirSyncJob) SetOverwrite(v bool) {
	x.xxx_hidden_Overwrite = v
}

func (x *DirSyncJob) SetRemotePath(v string) {
	x.xxx_hidden_RemotePath = v
}

func (x *DirSyncJob) SetFlatten(v bool) {
	x.xxx_hidden_Flatten = v
}

func (x *DirSyncJob) SetForce(v bool) {
	x.xxx_hidden_Force = v
}

func (x *DirSyncJob) SetStubOnly(v bool) {
	x.xxx_hidden_StubOnly = v
}

type DirSyncJob_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 DirSyncJob_builder) Build() *DirSyncJob {
	m0 := &DirSyncJob{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Operation = b.Operation
...
func (x case_RemoteStorageTarget_Type) String() string {
	md := file_flex_proto_msgTypes[17].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
var file_flex_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xf2, 0x03, 0x0a, 0x0b, 0x57, 0x6f, 0x72,
	...
	0x52, 0x04, 0x73, 0x79, 0x6e, 0x63, 0x12, 0x2d, 0x0a, 0x08, 0x64, 0x69, 0x72, 0x5f, 0x73, 0x79,
	0x6e, 0x63, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x66, 0x6c, 0x65, 0x78, 0x2e,
	0x44, 0x69, 0x72, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x48, 0x00, 0x52, 0x07, 0x64, 0x69,
	0x72, 0x53, 0x79, 0x6e, 0x63, 0x1a, 0x8d, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e,
	...
	0x73, 0x53, 0x74, 0x6f, 0x70, 0x42, 0x06, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x22, 0xb1, 0x01,
	...
	0x46, 0x61, 0x69, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x61, 0x6e, 0x5f, 0x72, 0x65, 0x74, 0x72,
	0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x63, 0x61, 0x6e, 0x52, 0x65, 0x74, 0x72,
	0x79, 0x22, 0x97, 0x01, 0x0a, 0x07, 0x53, 0x79, 0x6e, 0x63, 0x4a, 0x6f, 0x62, 0x12, 0x30, 0x0a,
	0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x12, 0x2e, 0x66, 0x6c, 0x65, 0x78, 0x2e, 0x4a, 0x6f, 0x62, 0x4f, 0x70, 0x65, 0x72, 0x61,
	...
	,
	...
	0x6b, 0x2e, 0x50, 0x61, 0x72, 0x74, 0x52, 0x05, 0x70, 0x61, 0x72, 0x74, 0x73, 0x1a, 0x4a, 0x0a,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x03, 0x22, 0x39, 0x0a,
	0x0d, 0x42, 0x65, 0x65, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x18,
	0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x9d, 0x05, 0x0a, 0x13, 0x52, 0x65, 0x6d,
	...
	0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x6d, 0x6f, 0x63, 0x6b, 0x1a, 0x39, 0x0a, 0x08,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0x2d, 0x0a, 0x13, 0x66, 0x61, 0x73, 0x74,
	0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x66, 0x61, 0x73, 0x74, 0x53, 0x74, 0x61, 0x72, 0x74,
	0x4d, 0x61, 0x78, 0x53, 0x69, 0x7a, 0x65, 0x1a, 0xb8, 0x01, 0x0a, 0x02, 0x53, 0x33, 0x12, 0x21,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x18, 0x03,
	...
	0x65, 0x79, 0x1a, 0x4f, 0x0a, 0x05, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x12, 0x2c, 0x0a, 0x02, 0x73,
	...
	0x65, 0x74, 0x2e, 0x53, 0x33, 0x52, 0x02, 0x73, 0x33, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x1a, 0x1b, 0x0a, 0x05, 0x50, 0x4f, 0x53, 0x49, 0x58, 0x12, 0x12, 0x0a, 0x04,
	0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68,
	0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x2a, 0x43, 0x0a, 0x0c, 0x4a, 0x6f, 0x62, 0x4f,
	...
	0x0c, 0x0a, 0x08, 0x44, 0x4f, 0x57, 0x4e, 0x4c, 0x4f, 0x41, 0x44, 0x10, 0x02, 0x32, 0xe0, 0x02,
...
var file_flex_proto_goTypes = []any{
	(JobOperation)(0),                    // 0: flex.JobOperation
	...
	(*DirSyncJob)(nil),                   // 17: flex.DirSyncJob
	(*Work)(nil),                         // 18: flex.Work
	(*UpdateConfigRequest)(nil),          // 19: flex.UpdateConfigRequest
	(*UpdateConfigResponse)(nil),         // 20: flex.UpdateConfigResponse
	(*BeeRemoteNode)(nil),                // 21: flex.BeeRemoteNode
	(*RemoteStorageTarget)(nil),          // 22: flex.RemoteStorageTarget
	(*WorkRequest_Segment)(nil),          // 23: flex.WorkRequest.Segment
...
var file_flex_proto_depIdxs = []int32{
	...
	18, // 3: flex.SubmitWorkResponse.work:type_name -> flex.Work
	1,  // 4: flex.UpdateWorkRequest.new_state:type_name -> flex.UpdateWorkRequest.NewState
	18, // 5: flex.UpdateWorkResponse.work:type_name -> flex.Work
	2,  // 6: flex.BulkUpdateWorkRequest.new_state:type_name -> flex.BulkUpdateWorkRequest.NewState
	23, // 7: flex.WorkRequest.segment:type_name -> flex.WorkRequest.Segment
	15, // 8: flex.WorkRequest.mock:type_name -> flex.MockJob
	16, // 9: flex.WorkRequest.sync:type_name -> flex.SyncJob
	17, // 10: flex.WorkRequest.dir_sync:type_name -> flex.DirSyncJob
	0,  // 11: flex.SyncJob.operation:type_name -> flex.JobOperation
	0,  // 12: flex.DirSyncJob.operation:type_name -> flex.JobOperation
	24, // 13: flex.Work.status:type_name -> flex.Work.Status
	25, // 14: flex.Work.parts:type_name -> flex.Work.Part
	21, // 15: flex.UpdateConfigRequest.bee_remote:type_name -> flex.BeeRemoteNode
	22, // 16: flex.UpdateConfigRequest.rsts:type_name -> flex.RemoteStorageTarget
	4,  // 17: flex.UpdateConfigResponse.result:type_name -> flex.UpdateConfigResponse.Result
	26, // 18: flex.RemoteStorageTarget.policies:type_name -> flex.RemoteStorageTarget.Policies
	27, // 19: flex.RemoteStorageTarget.s3:type_name -> flex.RemoteStorageTarget.S3
	29, // 20: flex.RemoteStorageTarget.posix:type_name -> flex.RemoteStorageTarget.POSIX
	28, // 21: flex.RemoteStorageTarget.azure:type_name -> flex.RemoteStorageTarget.Azure
	3,  // 22: flex.Work.Status.state:type_name -> flex.Work.State
	27, // 23: flex.RemoteStorageTarget.Azure.s3:type_name -> flex.RemoteStorageTarget.S3
	19, // 24: flex.WorkerNode.UpdateConfig:input_type -> flex.UpdateConfigRequest
	5,  // 25: flex.WorkerNode.Heartbeat:input_type -> flex.HeartbeatRequest
	8,  // 26: flex.WorkerNode.SubmitWork:input_type -> flex.SubmitWorkRequest
	10, // 27: flex.WorkerNode.UpdateWork:input_type -> flex.UpdateWorkRequest
	12, // 28: flex.WorkerNode.BulkUpdateWork:input_type -> flex.BulkUpdateWorkRequest
	20, // 29: flex.WorkerNode.UpdateConfig:output_type -> flex.UpdateConfigResponse
	6,  // 30: flex.WorkerNode.Heartbeat:output_type -> flex.HeartbeatResponse
	9,  // 31: flex.WorkerNode.SubmitWork:output_type -> flex.SubmitWorkResponse
	11, // 32: flex.WorkerNode.UpdateWork:output_type -> flex.UpdateWorkResponse
	13, // 33: flex.WorkerNode.BulkUpdateWork:output_type -> flex.BulkUpdateWorkResponse
...
func file_flex_proto_init() {
	...
	file_flex_proto_msgTypes[9].OneofWrappers = []any{
		...
		(*workRequest_DirSync)(nil),
	}
	file_flex_proto_msgTypes[17].OneofWrappers = []any{
