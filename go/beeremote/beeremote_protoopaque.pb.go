...
func (x *UpdateJobRequest) HasByExactPath() bool {
	if x == nil {
		return false
	}
...
const UpdateJobRequest_Query_not_set_case case_UpdateJobRequest_Query = 0
const UpdateJobRequest_ByIdAndPath_case case_UpdateJobRequest_Query = 1
const UpdateJobRequest_ByExactPath_case case_UpdateJobRequest_Query = 2

func (x *UpdateJobRequest) WhichQuery() case_UpdateJobRequest_Query {
	if x == nil {
...
type case_UpdateJobRequest_Query protoreflect.FieldNumber

func (x case_UpdateJobRequest_Query) String() string {
	md := file_beeremote_proto_msgTypes[5].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (b0 UpdateJobResponse_builder) Build() *UpdateJobResponse {
...
func (x case_GetJobsRequest_Query) String() string {
	md := file_beeremote_proto_msgTypes[7].Descriptor()
	if x == 0 {
		return "not set"
	}
	return protoimpl.X.MessageFieldStringOf(md, protoreflect.FieldNumber(x))
...
func (b0 UpdateJobRequest_QueryIdAndPath_builder) Build() *UpdateJobRequest_QueryIdAndPath {
