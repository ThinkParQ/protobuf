...
type SubmitJobRequest struct {
	...
	xxx_hidden_OriginNodeId string                 `protobuf:"bytes,2,opt,name=origin_node_id,json=originNodeId,proto3" json:"origin_node_id,omitempty"`
...
func (x *SubmitJobRequest) GetOriginNodeId() string {
	if x != nil {
		return x.xxx_hidden_OriginNodeId
	}
	return ""
}
...
func (b0 SubmitJobRequest_builder) Build() *SubmitJobRequest {
	...
	x.xxx_hidden_OriginNodeId = b.OriginNodeId
	return m0
}
...
type JobRequest struct {
	...
	xxx_hidden_BulkInfo            *flex.BulkJobRequestInfo     `protobuf:"bytes,15,opt,name=bulk_info,json=bulkInfo,proto3,oneof" json:"bulk_info,omitempty"`
...
type GetStubContentsResponse struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RstId       uint32                 `protobuf:"varint,1,opt,name=rst_id,json=rstId,proto3,oneof" json:"rst_id,omitempty"`
	xxx_hidden_Url         *string                `protobuf:"bytes,2,opt,name=url,proto3,oneof" json:"url,omitempty"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
