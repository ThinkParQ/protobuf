...
type JobRequest struct {
	...
	xxx_hidden_SortValues          []string                     `protobuf:"bytes,13,rep,name=sort_values,json=sortValues,proto3" json:"sort_values,omitempty"`
...
func (x *JobRequest) GetSortValues() []string {
	if x != nil {
		return x.xxx_hidden_SortValues
	}
	return nil
}
...
func (b0 JobRequest_builder) Build() *JobRequest {
	...
	x.xxx_hidden_SortValues = b.SortValues
	return m0
}
