...
func (x *JobRequest) GetDirSync() *flex.DirSyncJob {
	if x != nil {
		if x, ok := x.Type.(*JobRequest_DirSync); ok {
			return x.DirSync
		}
	}
	return nil
...
func (x *JobRequest) HasDirSync() bool {
	...
	_, ok := x.Type.(*JobRequest_DirSync)
	return ok
}
...
func (x *JobRequest) ClearDirSync() {
	if _, ok := x.Type.(*JobRequest_DirSync); ok {
		x.Type = nil
	}
}
...
func (b0 JobRequest_builder) Build() *JobRequest {
	...
	if b.DirSync != nil {
		x.Type = &JobRequest_DirSync{b.DirSync}
	}
	x.Force = b.Force
	return m0
}
