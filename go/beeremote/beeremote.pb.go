...
func (x *Job_Status) GetUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
var file_beeremote_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xaa, 0x02, 0x0a, 0x09,
	...
	,
...
var file_beeremote_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_beeremote_proto_goTypes = []interface{}{
	...
	(*Job_Status)(nil),                      // 13: beeremote.Job.Status
	(*JobResult_WorkResult)(nil),            // 14: beeremote.JobResult.WorkResult
	(*UpdateJobRequest_QueryIdAndPath)(nil), // 15: beeremote.UpdateJobRequest.QueryIdAndPath
	(*GetJobsRequest_QueryIdAndPath)(nil),   // 16: beeremote.GetJobsRequest.QueryIdAndPath
	(*flex.SyncJob)(nil),                    // 17: flex.SyncJob
	(*flex.MockJob)(nil),                    // 18: flex.MockJob
	(*timestamp.Timestamp)(nil),             // 19: google.protobuf.Timestamp
	(*flex.WorkRequest)(nil),                // 20: flex.WorkRequest
	(*flex.Work)(nil),                       // 21: flex.Work
}
var file_beeremote_proto_depIdxs = []int32{
	...
	17, // 2: beeremote.JobRequest.sync:type_name -> flex.SyncJob
	18, // 3: beeremote.JobRequest.mock:type_name -> flex.MockJob
	4,  // 4: beeremote.Job.request:type_name -> beeremote.JobRequest
	19, // 5: beeremote.Job.created:type_name -> google.protobuf.Timestamp
	13, // 6: beeremote.Job.status:type_name -> beeremote.Job.Status
	5,  // 7: beeremote.JobResult.job:type_name -> beeremote.Job
	20, // 8: beeremote.JobResult.work_requests:type_name -> flex.WorkRequest
	14, // 9: beeremote.JobResult.work_results:type_name -> beeremote.JobResult.WorkResult
	15, // 10: beeremote.UpdateJobRequest.by_id_and_path:type_name -> beeremote.UpdateJobRequest.QueryIdAndPath
	...
	16, // 13: beeremote.GetJobsRequest.by_job_id_and_path:type_name -> beeremote.GetJobsRequest.QueryIdAndPath
	6,  // 14: beeremote.GetJobsResponse.results:type_name -> beeremote.JobResult
	21, // 15: beeremote.UpdateWorkRequest.work:type_name -> flex.Work
	0,  // 16: beeremote.Job.Status.state:type_name -> beeremote.Job.State
	19, // 17: beeremote.Job.Status.updated:type_name -> google.protobuf.Timestamp
	21, // 18: beeremote.JobResult.WorkResult.work:type_name -> flex.Work
	2,  // 19: beeremote.BeeRemote.SubmitJob:input_type -> beeremote.SubmitJobRequest
	7,  // 20: beeremote.BeeRemote.UpdateJob:input_type -> beeremote.UpdateJobRequest
	9,  // 21: beeremote.BeeRemote.GetJobs:input_type -> beeremote.GetJobsRequest
	11, // 22: beeremote.BeeRemote.UpdateWork:input_type -> beeremote.UpdateWorkRequest
	3,  // 23: beeremote.BeeRemote.SubmitJob:output_type -> beeremote.SubmitJobResponse
	8,  // 24: beeremote.BeeRemote.UpdateJob:output_type -> beeremote.UpdateJobResponse
	10, // 25: beeremote.BeeRemote.GetJobs:output_type -> beeremote.GetJobsResponse
	12, // 26: beeremote.BeeRemote.UpdateWork:output_type -> beeremote.UpdateWorkResponse
