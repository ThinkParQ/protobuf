...
func (x *SubmitJobRequest) GetOriginNodeId() string {
	if x != nil {
...
func (x *SubmitJobRequest) SetOriginNodeId(v string) {
	x.OriginNodeId = v
}
...
type JobRequest struct {
	...
	GenerationStatus *JobRequest_GenerationStatus `protobuf:"bytes,8,opt,name=generation_status,json=generationStatus,proto3" json:"generation_status,omitempty"`
	Update           *bool                        `protobuf:"varint,9,opt,name=update,proto3,oneof" json:"update,omitempty"`
	// Controls the data state of the stub file when stub_local is true.
	RestorePolicy *flex.RestorePolicy `protobuf:"varint,13,opt,name=restore_policy,json=restorePolicy,proto3,enum=flex.RestorePolicy,oneof" json:"restore_policy,omitempty"`
	...
	// that bulk operation.
	BulkInfo      *flex.BulkJobRequestInfo `protobuf:"bytes,15,opt,name=bulk_info,json=bulkInfo,proto3,oneof" json:"bulk_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JobRequest) GetUpdate() bool {
...
func (x *JobRequest) GetBulkInfo() *flex.BulkJobRequestInfo {
	if x != nil {
		return x.BulkInfo
	}
	return nil
...
func (x *JobRequest) SetBulkInfo(v *flex.BulkJobRequestInfo) {
	x.BulkInfo = v
}
...
func (x *JobRequest) HasGenerationStatus() bool {
	...
	return x.GenerationStatus != nil
}

func (x *JobRequest) HasUpdate() bool {
	if x == nil {
		return false
	}
	return x.Update != nil
...
func (x *JobRequest) HasBulkInfo() bool {
	if x == nil {
		return false
	}
...
func (x *JobRequest) ClearBulkInfo() {
	x.BulkInfo = nil
}
...
func (b0 JobRequest_builder) Build() *JobRequest {
	...
	x.GenerationStatus = b.GenerationStatus
	x.Update = b.Update
...
type GetStubContentsRequest struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Path          string                 `protobuf:"bytes,1,opt,name=path,proto3" json:"path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetStubContentsRequest) Reset() {
	*x = GetStubContentsRequest{}
	mi := &file_beeremote_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetStubContentsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStubContentsRequest) ProtoMessage() {}

func (x *GetStubContentsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_beeremote_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *GetStubContentsRequest) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *GetStubContentsRequest) SetPath(v string) {
	x.Path = v
}

type GetStubContentsRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	Path string
}

func (b0 GetStubContentsRequest_builder) Build() *GetStubContentsRequest {
	m0 := &GetStubContentsRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.Path = b.Path
	return m0
...
type GetStubContentsResponse struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	RstId         *uint32                `protobuf:"varint,1,opt,name=rst_id,json=rstId,proto3,oneof" json:"rst_id,omitempty"`
	Url           *string                `protobuf:"bytes,2,opt,name=url,proto3,oneof" json:"url,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetStubContentsResponse) Reset() {
	*x = GetStubContentsResponse{}
	mi := &file_beeremote_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetStubContentsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetStubContentsResponse) ProtoMessage() {}

func (x *GetStubContentsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_beeremote_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *GetStubContentsResponse) GetRstId() uint32 {
	if x != nil && x.RstId != nil {
		return *x.RstId
	}
	return 0
}

func (x *GetStubContentsResponse) GetUrl() string {
	if x != nil && x.Url != nil {
		return *x.Url
	}
	return ""
...
func (x *GetStubContentsResponse) SetRstId(v uint32) {
	x.RstId = &v
}

func (x *GetStubContentsResponse) SetUrl(v string) {
	x.Url = &v
}

func (x *GetStubContentsResponse) HasRstId() bool {
	if x == nil {
		return false
	}
	return x.RstId != nil
...
func (x *GetStubContentsResponse) HasUrl() bool {
	if x == nil {
		return false
	}
	return x.Url != nil
...
func (x *GetStubContentsResponse) ClearRstId() {
	x.RstId = nil
}

func (x *GetStubContentsResponse) ClearUrl() {
	x.Url = nil
}

type GetStubContentsResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 GetStubContentsResponse_builder) Build() *GetStubContentsResponse {
	m0 := &GetStubContentsResponse{}
	b, x := &b0, m0
	_, _ = b, x
	x.RstId = b.RstId
	x.Url = b.Url
...
type JobRequest_GenerationStatus struct {
	state         protoimpl.MessageState            `protogen:"hybrid.v1"`
	State         JobRequest_GenerationStatus_State `protobuf:"varint,1,opt,name=state,proto3,enum=beeremote.JobRequest_GenerationStatus_State" json:"state,omitempty"`
	Message       string                            `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetJobsRequest_QueryIdAndPath) Reset() {
	*x = GetJobsRequest_QueryIdAndPath{}
	mi := &file_beeremote_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_beeremote_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x69, 0x0a, 0x10, 0x53, 0x75, 0x62,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x4e, 0x6f,
	0x64, 0x65, 0x49, 0x64, 0x22, 0x98, 0x02, 0x0a, 0x11, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x4a,
	0x6f, 0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x06, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x62, 0x65, 0x65,
	0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x43, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b, 0x2e, 0x62, 0x65, 0x65, 0x72, 0x65,
	...
	,
	...
	,
	...
	0x32, 0x2c, 0x2e, 0x62, 0x65, 0x65, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x4a, 0x6f, 0x62,
	...
	,
	...
	0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x52, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x34, 0x0a, 0x07, 0x63, 0x72, 0x65,
	...
	0x15, 0x2e, 0x62, 0x65, 0x65, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x4a, 0x6f, 0x62, 0x2e,
	...
	,
	...
	0x0b, 0x0a, 0x07, 0x52, 0x55, 0x4e, 0x4e, 0x49, 0x4e, 0x47, 0x10, 0x04, 0x12, 0x09, 0x0a, 0x05,
	...
	,
	...
	,
	...
	,
	...
	0x1c, 0x2e, 0x66, 0x6c, 0x65, 0x78, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e,
	0x66, 0x6c, 0x65, 0x78, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69,
	0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2c, 0x5a, 0x2a,
...
var file_beeremote_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_beeremote_proto_goTypes = []any{
	...
	(*GetStubContentsRequest)(nil),         // 19: beeremote.GetStubContentsRequest
	(*GetStubContentsResponse)(nil),        // 20: beeremote.GetStubContentsResponse
	(*JobRequest_GenerationStatus)(nil),    // 21: beeremote.JobRequest.GenerationStatus
	(*Job_Status)(nil),                     // 22: beeremote.Job.Status
	(*JobResult_WorkResult)(nil),           // 23: beeremote.JobResult.WorkResult
	nil,                                    // 24: beeremote.UpdateJobsRequest.RemoteTargetsEntry
	(*GetJobsRequest_QueryIdAndPath)(nil),  // 25: beeremote.GetJobsRequest.QueryIdAndPath
	...
	(*flex.BulkJobRequestInfo)(nil),        // 30: flex.BulkJobRequestInfo
	(*timestamppb.Timestamp)(nil),          // 31: google.protobuf.Timestamp
	(*flex.WorkRequest)(nil),               // 32: flex.WorkRequest
	(*flex.Work)(nil),                      // 33: flex.Work
	(*flex.RemoteStorageTarget)(nil),       // 34: flex.RemoteStorageTarget
	(*flex.GetCapabilitiesRequest)(nil),    // 35: flex.GetCapabilitiesRequest
	(*flex.GetCapabilitiesResponse)(nil),   // 36: flex.GetCapabilitiesResponse
}
var file_beeremote_proto_depIdxs = []int32{
	...
	26, // 3: beeremote.JobRequest.sync:type_name -> flex.SyncJob
	...
	30, // 8: beeremote.JobRequest.bulk_info:type_name -> flex.BulkJobRequestInfo
	6,  // 9: beeremote.Job.request:type_name -> beeremote.JobRequest
	31, // 10: beeremote.Job.created:type_name -> google.protobuf.Timestamp
	22, // 11: beeremote.Job.status:type_name -> beeremote.Job.Status
	31, // 12: beeremote.Job.start_mtime:type_name -> google.protobuf.Timestamp
	31, // 13: beeremote.Job.stop_mtime:type_name -> google.protobuf.Timestamp
	7,  // 14: beeremote.JobResult.job:type_name -> beeremote.Job
	32, // 15: beeremote.JobResult.work_requests:type_name -> flex.WorkRequest
	23, // 16: beeremote.JobResult.work_results:type_name -> beeremote.JobResult.WorkResult
	11, // 17: beeremote.UpdatePathsRequest.requested_update:type_name -> beeremote.UpdateJobsRequest
	12, // 18: beeremote.UpdatePathsResponse.update_result:type_name -> beeremote.UpdateJobsResponse
	24, // 19: beeremote.UpdateJobsRequest.remote_targets:type_name -> beeremote.UpdateJobsRequest.RemoteTargetsEntry
	3,  // 20: beeremote.UpdateJobsRequest.new_state:type_name -> beeremote.UpdateJobsRequest.NewState
	8,  // 21: beeremote.UpdateJobsResponse.results:type_name -> beeremote.JobResult
	25, // 22: beeremote.GetJobsRequest.by_job_id_and_path:type_name -> beeremote.GetJobsRequest.QueryIdAndPath
	8,  // 23: beeremote.GetJobsResponse.results:type_name -> beeremote.JobResult
	33, // 24: beeremote.UpdateWorkRequest.work:type_name -> flex.Work
	34, // 25: beeremote.GetRSTConfigResponse.rsts:type_name -> flex.RemoteStorageTarget
	1,  // 26: beeremote.JobRequest.GenerationStatus.state:type_name -> beeremote.JobRequest.GenerationStatus.State
	2,  // 27: beeremote.Job.Status.state:type_name -> beeremote.Job.State
	31, // 28: beeremote.Job.Status.updated:type_name -> google.protobuf.Timestamp
	33, // 29: beeremote.JobResult.WorkResult.work:type_name -> flex.Work
	4,  // 30: beeremote.BeeRemote.SubmitJob:input_type -> beeremote.SubmitJobRequest
	9,  // 31: beeremote.BeeRemote.UpdatePaths:input_type -> beeremote.UpdatePathsRequest
	11, // 32: beeremote.BeeRemote.UpdateJobs:input_type -> beeremote.UpdateJobsRequest
	13, // 33: beeremote.BeeRemote.GetJobs:input_type -> beeremote.GetJobsRequest
	15, // 34: beeremote.BeeRemote.UpdateWork:input_type -> beeremote.UpdateWorkRequest
	17, // 35: beeremote.BeeRemote.GetRSTConfig:input_type -> beeremote.GetRSTConfigRequest
	19, // 36: beeremote.BeeRemote.GetStubContents:input_type -> beeremote.GetStubContentsRequest
	35, // 37: beeremote.BeeRemote.GetCapabilities:input_type -> flex.GetCapabilitiesRequest
	5,  // 38: beeremote.BeeRemote.SubmitJob:output_type -> beeremote.SubmitJobResponse
	10, // 39: beeremote.BeeRemote.UpdatePaths:output_type -> beeremote.UpdatePathsResponse
	12, // 40: beeremote.BeeRemote.UpdateJobs:output_type -> beeremote.UpdateJobsResponse
	14, // 41: beeremote.BeeRemote.GetJobs:output_type -> beeremote.GetJobsResponse
	16, // 42: beeremote.BeeRemote.UpdateWork:output_type -> beeremote.UpdateWorkResponse
	18, // 43: beeremote.BeeRemote.GetRSTConfig:output_type -> beeremote.GetRSTConfigResponse
	20, // 44: beeremote.BeeRemote.GetStubContents:output_type -> beeremote.GetStubContentsResponse
	36, // 45: beeremote.BeeRemote.GetCapabilities:output_type -> flex.GetCapabilitiesResponse
...
func file_beeremote_proto_init() {
	...
	file_beeremote_proto_msgTypes[16].OneofWrappers = []any{}
	type x struct{}
