...
type UpdateManifestRequest struct {
	...
	Config        map[string]*Filesystem `protobuf:"bytes,1,rep,name=config,proto3" json:"config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Status struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	State         Status_State           `protobuf:"varint,1,opt,name=state,proto3,enum=agent.Status_State" json:"state,omitempty"`
...
type InstallSource struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Type          InstallType            `protobuf:"varint,1,opt,name=type,proto3,enum=agent.InstallType" json:"type,omitempty"`
	Repo          string                 `protobuf:"bytes,2,opt,name=repo,proto3" json:"repo,omitempty"`
	Refs          []*SourceRef           `protobuf:"bytes,3,rep,name=refs,proto3" json:"refs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SourceRef struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	ServiceType   beegfs.NodeType        `protobuf:"varint,1,opt,name=service_type,json=serviceType,proto3,enum=beegfs.NodeType" json:"service_type,omitempty"`
...
type Service struct {
	...
	ServiceType beegfs.NodeType        `protobuf:"varint,2,opt,name=service_type,json=serviceType,proto3,enum=beegfs.NodeType" json:"service_type,omitempty"`
...
type Filesystem_Common struct {
	...
	Tls           *TLS                   `protobuf:"bytes,2,opt,name=tls,proto3,oneof" json:"tls,omitempty"`
	InstallSource *InstallSource         `protobuf:"bytes,3,opt,name=install_source,json=installSource,proto3" json:"install_source,omitempty"`
	GlobalConfig  []*ServiceConfig       `protobuf:"bytes,4,rep,name=global_config,json=globalConfig,proto3" json:"global_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (b0 Filesystem_Common_builder) Build() *Filesystem_Common {
	...
	x.Auth = b.Auth
	x.Tls = b.Tls
	x.InstallSource = b.InstallSource
	x.GlobalConfig = b.GlobalConfig
	return m0
}
...
type Target_UnderlyingFSOpts struct {
	...
	Type          Target_UnderlyingFSOpts_FsType `protobuf:"varint,2,opt,name=type,proto3,enum=agent.Target_UnderlyingFSOpts_FsType" json:"type,omitempty"`
