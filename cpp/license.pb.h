...
/* @@protoc_insertion_point(class_definition:license.VerifyFeatureResult) */ {
 ...
 public:
  ...
  public:
  // optional .license.VerifyResult result = 1;
...
/* @@protoc_insertion_point(class_definition:license.CertData) */ {
 ...
 public:
  ...
  bool has_organizationalunit() const;
  ...
  public:
  // optional .license.CertType type = 1;
  bool has_type() const;
  void clear_type() ;
...
/* @@protoc_insertion_point(class_definition:license.GetCertDataResult) */ {
 ...
 public:
  ...
  public:
  // optional .license.CertData data = 2;
  bool has_data() const;
  void clear_data() ;
...
// optional .license.VerifyResult result = 1;
inline bool VerifyCertResult::has_result() const {
...
// optional string serial = 2;
inline bool VerifyCertResult::has_serial() const {
...
// optional string message = 3;
inline bool VerifyCertResult::has_message() const {
...
// optional .license.VerifyResult result = 1;
inline bool VerifyFeatureResult::has_result() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
...
// optional string message = 2;
inline bool VerifyFeatureResult::has_message() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
// optional .license.VerifyResult result = 1;
inline bool GetCertDataResult::has_result() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
...
// optional string message = 3;
inline bool GetCertDataResult::has_message() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
// optional .license.CertType type = 1;
inline bool CertData::has_type() const {
...
// optional int64 serial = 2;
inline bool CertData::has_serial() const {
...
// optional string organization = 3;
inline bool CertData::has_organization() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
// optional string organizationalUnit = 4;
inline bool CertData::has_organizationalunit() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
...
inline std::string* CertData::release_organizationalunit() {
  ...
  _impl_._has_bits_[0] &= ~0x00000002u;
  auto* released = _impl_.organizationalunit_.Release();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
// optional string country = 5;
inline bool CertData::has_country() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
...
// optional string locality = 6;
inline bool CertData::has_locality() const {
...
// optional string commonName = 7;
inline bool CertData::has_commonname() const {
...
inline std::string* CertData::release_commonname() {
  ...
  _impl_._has_bits_[0] &= ~0x00000010u;
  auto* released = _impl_.commonname_.Release();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
// optional bool is_ca = 11;
inline bool CertData::has_is_ca() const {
