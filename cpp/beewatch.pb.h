...
/* @@protoc_insertion_point(class_definition:beewatch.V2Event) */ {
 public:
  ...
  void operator delete(V2Event* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  V2Event* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:beewatch.V1Event) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(V1Event* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  V1Event* New(::google::protobuf::Arena* arena = nullptr) const {
