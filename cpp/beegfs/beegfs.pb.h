...
class GetNodeInfoResp;
class GetNodeInfoRespDefaultTypeInternal;
extern GetNodeInfoRespDefaultTypeInternal _GetNodeInfoResp_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::beegfs::GetNodeInfoReq* Arena::CreateMaybeMessage<::beegfs::GetNodeInfoReq>(Arena*);
template<> ::beegfs::GetNodeInfoResp* Arena::CreateMaybeMessage<::beegfs::GetNodeInfoResp>(Arena*);
...
class GetNodeInfoReq PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:beegfs.GetNodeInfoReq) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:beegfs.GetNodeInfoReq)
 private:
  class _Internal;
  void set_has_uid();
  void set_has_alias();
...
class GetNodeInfoResp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:beegfs.GetNodeInfoResp) */ {
 public:
  inline GetNodeInfoResp() : GetNodeInfoResp(nullptr) {};
  virtual ~GetNodeInfoResp();

  GetNodeInfoResp(const GetNodeInfoResp& from);
  GetNodeInfoResp(GetNodeInfoResp&& from) noexcept
    : GetNodeInfoResp() {
    *this = ::std::move(from);
  }

  inline GetNodeInfoResp& operator=(const GetNodeInfoResp& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetNodeInfoResp& operator=(GetNodeInfoResp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetNodeInfoResp& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetNodeInfoResp* internal_default_instance() {
    return reinterpret_cast<const GetNodeInfoResp*>(
               &_GetNodeInfoResp_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetNodeInfoResp& a, GetNodeInfoResp& b) {
    a.Swap(&b);
  }
  inline void Swap(GetNodeInfoResp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(GetNodeInfoResp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline GetNodeInfoResp* New() const final {
    return CreateMaybeMessage<GetNodeInfoResp>(nullptr);
  }

  GetNodeInfoResp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetNodeInfoResp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetNodeInfoResp& from);
  void MergeFrom(const GetNodeInfoResp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetNodeInfoResp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "beegfs.GetNodeInfoResp";
  }
  protected:
  explicit GetNodeInfoResp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:beegfs.GetNodeInfoResp)
 private:
  class _Internal;
...
// int64 uid = 1;
inline bool GetNodeInfoReq::_internal_has_uid() const {
  return key_case() == kUid;
}
inline void GetNodeInfoReq::set_has_uid() {
  _oneof_case_[0] = kUid;
}
inline void GetNodeInfoReq::clear_uid() {
  if (_internal_has_uid()) {
    key_.uid_ = PROTOBUF_LONGLONG(0);
    clear_has_key();
  }
}
inline ::PROTOBUF_NAMESPACE_ID::int64 GetNodeInfoReq::_internal_uid() const {
  if (_internal_has_uid()) {
    return key_.uid_;
  }
  return PROTOBUF_LONGLONG(0);
}
inline void GetNodeInfoReq::_internal_set_uid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  if (!_internal_has_uid()) {
    clear_key();
    set_has_uid();
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int64 GetNodeInfoReq::uid() const {
  // @@protoc_insertion_point(field_get:beegfs.GetNodeInfoReq.uid)
  return _internal_uid();
}
inline void GetNodeInfoReq::set_uid(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_uid(value);
  // @@protoc_insertion_point(field_set:beegfs.GetNodeInfoReq.uid)
}

// string alias = 2;
inline bool GetNodeInfoReq::_internal_has_alias() const {
  return key_case() == kAlias;
}
inline void GetNodeInfoReq::set_has_alias() {
  _oneof_case_[0] = kAlias;
}
inline void GetNodeInfoReq::clear_alias() {
  if (_internal_has_alias()) {
    key_.alias_.Destroy(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
    clear_has_key();
  }
}
inline const std::string& GetNodeInfoReq::alias() const {
  // @@protoc_insertion_point(field_get:beegfs.GetNodeInfoReq.alias)
  return _internal_alias();
}
inline void GetNodeInfoReq::set_alias(const std::string& value) {
  _internal_set_alias(value);
  // @@protoc_insertion_point(field_set:beegfs.GetNodeInfoReq.alias)
}
inline std::string* GetNodeInfoReq::mutable_alias() {
  // @@protoc_insertion_point(field_mutable:beegfs.GetNodeInfoReq.alias)
  return _internal_mutable_alias();
}
inline const std::string& GetNodeInfoReq::_internal_alias() const {
  if (_internal_has_alias()) {
    return key_.alias_.Get();
  }
  return *&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void GetNodeInfoReq::_internal_set_alias(const std::string& value) {
  if (!_internal_has_alias()) {
    clear_key();
    set_has_alias();
    key_.alias_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  key_.alias_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void GetNodeInfoReq::set_alias(std::string&& value) {
  // @@protoc_insertion_point(field_set:beegfs.GetNodeInfoReq.alias)
  if (!_internal_has_alias()) {
    clear_key();
    set_has_alias();
  ...
  key_.alias_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:beegfs.GetNodeInfoReq.alias)
}
inline void GetNodeInfoReq::set_alias(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  if (!_internal_has_alias()) {
    clear_key();
    set_has_alias();
  ...
  key_.alias_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:beegfs.GetNodeInfoReq.alias)
}
inline void GetNodeInfoReq::set_alias(const char* value,
                             size_t size) {
  if (!_internal_has_alias()) {
  ...
  key_.alias_.Set(
      ...
      GetArena());
  // @@protoc_insertion_point(field_set_pointer:beegfs.GetNodeInfoReq.alias)
}
inline std::string* GetNodeInfoReq::_internal_mutable_alias() {
  if (!_internal_has_alias()) {
    clear_key();
    set_has_alias();
    key_.alias_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  return key_.alias_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* GetNodeInfoReq::release_alias() {
  // @@protoc_insertion_point(field_release:beegfs.GetNodeInfoReq.alias)
  if (_internal_has_alias()) {
    clear_has_key();
    return key_.alias_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
inline void GetNodeInfoReq::set_allocated_alias(std::string* alias) {
  if (has_key()) {
    clear_key();
  }
  if (alias != nullptr) {
    set_has_alias();
    key_.alias_.UnsafeSetDefault(alias);
  }
  // @@protoc_insertion_point(field_set_allocated:beegfs.GetNodeInfoReq.alias)
}
inline std::string* GetNodeInfoReq::unsafe_arena_release_alias() {
  // @@protoc_insertion_point(field_unsafe_arena_release:beegfs.GetNodeInfoReq.alias)
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (_internal_has_alias()) {
    clear_has_key();
    return key_.alias_.UnsafeArenaRelease(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
inline void GetNodeInfoReq::unsafe_arena_set_allocated_alias(std::string* alias) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (!_internal_has_alias()) {
    key_.alias_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  ...
  if (alias) {
    set_has_alias();
    key_.alias_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), alias, GetArena());
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:beegfs.GetNodeInfoReq.alias)
}

inline bool GetNodeInfoReq::has_key() const {
  return key_case() != KEY_NOT_SET;
}
inline void GetNodeInfoReq::clear_has_key() {
  _oneof_case_[0] = KEY_NOT_SET;
}
inline GetNodeInfoReq::KeyCase GetNodeInfoReq::key_case() const {
  return GetNodeInfoReq::KeyCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// repeated .beegfs.Nic nics = 1;
inline int GetNodeInfoResp::_internal_nics_size() const {
  return nics_.size();
}
inline int GetNodeInfoResp::nics_size() const {
  return _internal_nics_size();
}
inline void GetNodeInfoResp::clear_nics() {
  nics_.Clear();
}
inline ::beegfs::Nic* GetNodeInfoResp::mutable_nics(int index) {
  // @@protoc_insertion_point(field_mutable:beegfs.GetNodeInfoResp.nics)
  return nics_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::beegfs::Nic >*
GetNodeInfoResp::mutable_nics() {
  // @@protoc_insertion_point(field_mutable_list:beegfs.GetNodeInfoResp.nics)
  return &nics_;
}
inline const ::beegfs::Nic& GetNodeInfoResp::_internal_nics(int index) const {
  return nics_.Get(index);
}
inline const ::beegfs::Nic& GetNodeInfoResp::nics(int index) const {
  // @@protoc_insertion_point(field_get:beegfs.GetNodeInfoResp.nics)
  return _internal_nics(index);
}
inline ::beegfs::Nic* GetNodeInfoResp::_internal_add_nics() {
  return nics_.Add();
}
inline ::beegfs::Nic* GetNodeInfoResp::add_nics() {
  // @@protoc_insertion_point(field_add:beegfs.GetNodeInfoResp.nics)
  return _internal_add_nics();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::beegfs::Nic >&
GetNodeInfoResp::nics() const {
  // @@protoc_insertion_point(field_list:beegfs.GetNodeInfoResp.nics)
  return nics_;
}
