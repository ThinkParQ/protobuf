...
// string tier = 1;
inline void RemoteStorageTarget_S3_StorageClass_Archival::clear_tier() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.tier_.ClearToEmpty();
}
inline const std::string& RemoteStorageTarget_S3_StorageClass_Archival::tier() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:flex.RemoteStorageTarget.S3.StorageClass.Archival.tier)
  return _internal_tier();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void RemoteStorageTarget_S3_StorageClass_Archival::set_tier(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.tier_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:flex.RemoteStorageTarget.S3.StorageClass.Archival.tier)
}
inline std::string* RemoteStorageTarget_S3_StorageClass_Archival::mutable_tier() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_tier();
  // @@protoc_insertion_point(field_mutable:flex.RemoteStorageTarget.S3.StorageClass.Archival.tier)
  return _s;
}
inline const std::string& RemoteStorageTarget_S3_StorageClass_Archival::_internal_tier() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.tier_.Get();
}
inline void RemoteStorageTarget_S3_StorageClass_Archival::_internal_set_tier(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.tier_.Set(value, GetArena());
}
inline std::string* RemoteStorageTarget_S3_StorageClass_Archival::_internal_mutable_tier() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.tier_.Mutable( GetArena());
}
inline std::string* RemoteStorageTarget_S3_StorageClass_Archival::release_tier() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:flex.RemoteStorageTarget.S3.StorageClass.Archival.tier)
  return _impl_.tier_.Release();
}
inline void RemoteStorageTarget_S3_StorageClass_Archival::set_allocated_tier(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  // @@protoc_insertion_point(field_set_allocated:flex.RemoteStorageTarget.S3.StorageClass.Archival.tier)
}
