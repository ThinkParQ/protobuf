...
Thank you for your interest in contributing to `protobuf`! 🎉
...
1. Please search [existing issues](https://github.com/ThinkParQ/protobuf/issues) to determine if an
   issue already exists for what you intend to contribute.
2. If the issue does not exist, [create a new
   one](https://github.com/ThinkParQ/protobuf/issues/new) that explains the bug or feature request.
...
4. Make changes to the `.proto` file(s) and supporting infrastructure (i.e., Makefile) as needed.
    * Ensure updates to the protocol buffers follow the official [style
      guide](https://protobuf.dev/programming-guides/style/) and [best
      practices](https://protobuf.dev/best-practices/).
    * Do not edit the generated code found under the various language folders. Refer to the README
      for how to regenerate/compile the library code after updating the `.proto` files.
...
Thank you for considering to contribute to `protobuf`!